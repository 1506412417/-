...
class Page{
    ...
    public function __construct($totalRows, $listRows=20, $parameter = array()) {
        ...
        // 计算当前的第一条记录和最后一条记录号
        $this->firstNum = $this->firstRow + 1;
        $this->lastNum = $this->firstRow + $this->listRows;
        // 别越界
        if ($this->lastNum > $this->totalRows) {
            $this->lastNum = $this->totalRows;
        }
    }
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            array('%HEADER%', '%NOW_PAGE%', '%UP_PAGE%', '%DOWN_PAGE%', '%FIRST%', '%LINK_PAGE%', '%END%', '%TOTAL_ROW%', '%TOTAL_PAGE%', '%FIRST_NUM%', '%LAST_NUM%'),
            // array($this->config['header'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages),
            array($this->config['header'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages, $this->firstNum, $this->lastNum),
            $this->config['theme']);
