...
class OrderController
{
    public function processAction()
    {
        ...
        while (true) {
            ...
            // 生成订单, 扣减库存
            $data = [
                'order_sn' => $order_sn,//唯一标识
                'member_id' => $orderInfo['member_id'],//会员id
                'created_at' => time(),  //创建时间
                'total_quantity'    => $orderInfo['cartInfo']['cart']['total_quantity'],//总数量
                'total_price'   => $orderInfo['cartInfo']['cart']['total'],//总价格
                'order_status_id'   => 1,  //默认订单状态
                'shipping_status_id'    => 1, //默认货运状态
                'payment_status_id' => 1,  //默认支付状态
                'address_id'    => $orderInfo['address_id'], //地址
            ];
            // 插入订单表
