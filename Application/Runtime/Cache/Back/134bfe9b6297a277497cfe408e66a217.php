                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'user_id', $filter);?>" class="<?php echo CField($sort, 'user_id');?>">ID</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'username', $filter);?>" class="<?php echo CField($sort, 'username');?>">用户名</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">密码</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">盐</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-left">
                                            <?php echo ($row['password_salt']); ?>
                                        </td>


                                        <td class="text-right">
                                            <a href="<?php echo U('edit', ['user_id'=>$row['user_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">
