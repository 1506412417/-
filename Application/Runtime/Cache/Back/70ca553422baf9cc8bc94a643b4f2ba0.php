                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        <input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" />
                                                                        ...
                                                                        <td class="text-left">
                                        <a href="javascript:;" class="">标识</a>
                                    </td>                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'title', $filter);?>" class="<?php echo CField($sort, 'title');?>">配送方式</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">是否启用</a>
                                    </td>                                    <td class="text-left">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['shipping_id']); ?>" />
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo U('edit', ['shipping_id'=>$row['shipping_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                            <?php if($row['is_new']): ?><a href="<?php echo U('install', ['key'=>$row['key']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">装</a><?php endif; ?>
                                        </td>
