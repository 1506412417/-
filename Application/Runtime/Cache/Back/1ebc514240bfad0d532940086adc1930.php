                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        <input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" />
                                                                        ...
                                                                        <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'id', $filter);?>" class="<?php echo CField($sort, 'id');?>">ID</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'name', $filter);?>" class="<?php echo CField($sort, 'name');?>">节点名称</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'title', $filter);?>" class="<?php echo CField($sort, 'title');?>">标题</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">状态</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">备注</a>
                                    </td>                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'sort', $filter);?>" class="<?php echo CField($sort, 'sort');?>">顺序</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'pid', $filter);?>" class="<?php echo CField($sort, 'pid');?>">上级ID</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'level', $filter);?>" class="<?php echo CField($sort, 'level');?>">层级</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-left">
                                            <?php switch($row['level']): case "1": ?>模块<?php break;?>
                                                <?php case "2": ?>控制器<?php break;?>
                                                <?php case "3": ?>动作<?php break; endswitch;?>
                                        </td>
