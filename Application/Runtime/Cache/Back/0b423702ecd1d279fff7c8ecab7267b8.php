                    ...
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-name">图书名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="<?php echo ($data['name']); ?>" placeholder="图书名称" id="input-name" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-time">出版时间</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="time" value="<?php echo ($data['time']); ?>" placeholder="出版时间" id="input-time" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-price">图书定价</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="price" value="<?php echo ($data['price']); ?>" placeholder="图书定价" id="input-price" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-writer">作者</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="writer" value="<?php echo ($data['writer']); ?>" placeholder="作者" id="input-writer" class="form-control">
                                        <?php if(isset($message['errorInfo']['writer'])): ?><label for="input-writer" class="text-danger"><?php echo ($message['errorInfo']['writer']); ?></label><?php endif; ?>
                                    </div>
                                </div>
