                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        ...
                                        <a href="<?php echo UField('list', $sort, 'attribute_type_title', $filter);?>" class="<?php echo CField($sort, 'attribute_type_title');?>">输入类型</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['attribute_type_id']); ?>" />
                                        </td>

                                                                                <td class="text-left">
                                            <?php echo ($row['attribute_type_id']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['attribute_type_title']); ?>
                                        </td>
                                        
                                        <td class="text-right">
                                            <a href="<?php echo U('edit', ['attribute_type_id'=>$row['attribute_type_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">
