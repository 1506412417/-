                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="keyword" value="<?php echo ($filter['keyword']); ?>"  id="input-keyword" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        ...
                                        <a href="<?php echo UField('list', $sort, 'name', $filter);?>" class="<?php echo CField($sort, 'name');?>">角色</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'pid', $filter);?>" class="<?php echo CField($sort, 'pid');?>">上级</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'status', $filter);?>" class="<?php echo CField($sort, 'status');?>">状态</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'remark', $filter);?>" class="<?php echo CField($sort, 'remark');?>">备注</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo U('access', ['id'=>$row['id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">权</a>
                                            <a href="<?php echo U('edit', ['id'=>$row['id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                        </td>
