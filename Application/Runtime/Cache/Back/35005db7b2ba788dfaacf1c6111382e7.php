        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- /entry.php/Back/Shipping/edit -->
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        <?php if(ACTION_NAME == 'edit'): ?><input type="hidden" name="shipping_id" id="input-shipping_id" value="<?php echo ($data['shipping_id']); ?>"><?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-key">标识</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="key" value="<?php echo ($data['key']); ?>" placeholder="标识" id="input-key" class="form-control">
                                        <?php if(isset($message['errorInfo']['key'])): ?><label for="input-key" class="text-danger"><?php echo ($message['errorInfo']['key']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-title">配送方式</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="title" value="<?php echo ($data['title']); ?>" placeholder="配送方式" id="input-title" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-enabled">是否启用</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="enabled" value="<?php echo ($data['enabled']); ?>" placeholder="是否启用" id="input-enabled" class="form-control">
                                        <?php if(isset($message['errorInfo']['enabled'])): ?><label for="input-enabled" class="text-danger"><?php echo ($message['errorInfo']['enabled']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
