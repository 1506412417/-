        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- /entry.php/Back/Admin/add -->
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        <?php if(ACTION_NAME == 'edit'): ?><input type="hidden" name="user_id" id="input-user_id" value="<?php echo ($data['user_id']); ?>"><?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="username" value="<?php echo ($data['username']); ?>" placeholder="用户名" id="input-username" class="form-control">
                                        <?php if(isset($message['errorInfo']['username'])): ?><label for="input-username" class="text-danger"><?php echo ($message['errorInfo']['username']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-password">密码</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="password" value="<?php echo ($data['password']); ?>" placeholder="密码" id="input-password" class="form-control">
                                        <?php if(isset($message['errorInfo']['password'])): ?><label for="input-password" class="text-danger"><?php echo ($message['errorInfo']['password']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-password_salt">盐</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="password_salt" value="<?php echo ($data['password_salt']); ?>" placeholder="盐" id="input-password_salt" class="form-control">
                                        <?php if(isset($message['errorInfo']['password_salt'])): ?><label for="input-password_salt" class="text-danger"><?php echo ($message['errorInfo']['password_salt']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <?php if(is_array($roleList)): $i = 0; $__LIST__ = $roleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><div class="col-sm-2">
                                                    <input type="checkbox" name="roleList[]" value="<?php echo ($role['id']); ?>" class="form-control" id="input-role-<?php echo ($role['id']); ?>" <?php if(in_array($role['id'], $data['roleList'])): ?>checked<?php endif; ?> >
                                                    <label for="input-role-<?php echo ($role['id']); ?>"><?php echo ($role['name']); ?></label>
                                                </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                        <?php if(isset($message['errorInfo']['password_salt'])): ?><label for="input-password_salt" class="text-danger"><?php echo ($message['errorInfo']['roleList']); ?></label><?php endif; ?>
                                    </div>
                                </div>
