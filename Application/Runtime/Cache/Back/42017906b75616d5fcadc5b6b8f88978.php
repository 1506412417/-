        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo U('list');?>">属性输入类型</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- /php4/buyplus/index.php/Back/AttributeType/add -->
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        <?php if(ACTION_NAME == 'edit'): ?><input type="hidden" name="attribute_type_id" id="input-attribute_type_id" value="<?php echo ($data['attribute_type_id']); ?>"><?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-attribute_type_title">输入类型</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="attribute_type_title" value="<?php echo ($data['attribute_type_title']); ?>" placeholder="输入类型" id="input-attribute_type_title" class="form-control">
                                        <?php if(isset($message['errorInfo']['attribute_type_title'])): ?><label for="input-attribute_type_title" class="text-danger"><?php echo ($message['errorInfo']['attribute_type_title']); ?></label><?php endif; ?>
                                    </div>
                                </div>
