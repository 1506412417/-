                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        <input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" />
                                                                        ...
                                                                        <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'attribute_id', $filter);?>" class="<?php echo CField($sort, 'attribute_id');?>">ID</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'attribute_title', $filter);?>" class="<?php echo CField($sort, 'attribute_title');?>">属性标题</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'type_id', $filter);?>" class="<?php echo CField($sort, 'type_id');?>">所属商品类型</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'attribute_type_id', $filter);?>" class="<?php echo CField($sort, 'attribute_type_id');?>">所属输入类型</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'sort_number', $filter);?>" class="<?php echo CField($sort, 'sort_number');?>">排序</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['attribute_id']); ?>" />
                                                                                ...
                                                                                <td class="text-left">
                                            <?php echo ($row['attribute_id']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['attribute_title']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['type_id']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['attribute_type_id']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['sort_number']); ?>
                                        </td>
                                        
                                        <td class="text-right">
                                            <a href="<?php echo U('edit', ['attribute_id'=>$row['attribute_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">
