                    ...
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-name">角色</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="<?php echo ($data['name']); ?>" placeholder="角色" id="input-name" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-pid">上级</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="pid" value="<?php echo ($data['pid']); ?>" placeholder="上级" id="input-pid" class="form-control">
