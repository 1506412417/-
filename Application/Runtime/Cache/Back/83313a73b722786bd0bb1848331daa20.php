        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- /php4/buyplus/index.php/Back/Attribute/edit -->
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        <?php if(ACTION_NAME == 'edit'): ?><input type="hidden" name="attribute_id" id="input-attribute_id" value="<?php echo ($data['attribute_id']); ?>"><?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-attribute_title">属性标题</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="attribute_title" value="<?php echo ($data['attribute_title']); ?>" placeholder="属性标题" id="input-attribute_title" class="form-control">
                                        <?php if(isset($message['errorInfo']['attribute_title'])): ?><label for="input-attribute_title" class="text-danger"><?php echo ($message['errorInfo']['attribute_title']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-type_id">所属商品类型</label>
                                    <div class="col-sm-10">
                                        <select name="type_id" id="input-type_id" class="form-control">
                                            <?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type['type_id']); ?>" <?php if($type['type_id'] == $data['type_id']): ?>selected<?php endif; ?>><?php echo ($type['type_title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-attribute_type_id">所属输入类型</label>
                                    <div class="col-sm-10">
                                        <select name="attribute_type_id" id="input-attribute_type_id" class="form-control">
                                            <?php if(is_array($attributeTypeList)): $i = 0; $__LIST__ = $attributeTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attribute_type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($attribute_type['attribute_type_id']); ?>" <?php if($attribute_type['attribute_type_id'] == $data['attribute_type_id']): ?>selected<?php endif; ?>><?php echo ($attribute_type['attribute_type_title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                        <?php if(isset($message['errorInfo']['attribute_type_id'])): ?><label for="input-attribute_type_id" class="text-danger"><?php echo ($message['errorInfo']['attribute_type_id']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-option_list">选项预设值</label>
                                    <div class="col-sm-10">
                                        <textarea name="option_list" placeholder="选项列表, 每行表示一个选项" id="input-option_list" class="form-control"><?php echo ($optionList); ?></textarea>
                                        <?php if(isset($message['errorInfo']['option_list'])): ?><label for="input-option_list" class="text-danger"><?php echo ($message['errorInfo']['option_list']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
