    ...
    <ul id="menu">
      ...
      <li id="catalog">
        ...
        <ul>
          ...
          <li>
            <a href="<?php echo U('back/goods/list');?>">信息管理</a>
          </li>
        </ul>
      </li>
      <li id="extension">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        <input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" />
                                                                        ...
                                                                        <td class="text-left">
                                        <a href="javascript:;" class="">ID</a>
                                    </td>                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'name', $filter);?>" class="<?php echo CField($sort, 'name');?>">商品</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">缩略图</a>
                                    </td>                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'quantity', $filter);?>" class="<?php echo CField($sort, 'quantity');?>">库存</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">商品代码</a>
                                    </td>                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'price', $filter);?>" class="<?php echo CField($sort, 'price');?>">本店售价</a>
                                    </td>
                                    <td class="text-left">
                                        <a href="javascript:;" class="">库存状态</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">是否销售</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">品牌</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">分类</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">更新时间</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['goods_id']); ?>" />
                                        </td>

                                                                                <td class="text-left">
                                            <?php echo ($row['goods_id']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['name']); ?>
                                        </td>                                        <td class="text-left">
                                            <?php echo ($row['image_thumb']); ?>
                                        </td>                                        <td class="text-left">
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo U('edit', ['goods_id'=>$row['goods_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo U('product', ['goods_id'=>$row['goods_id']]);?>" data-toggle="tooltip" title="货品" class="btn btn-primary">
                                                货
                                            </a>
                                        </td>
