                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="width: 1px;" class="text-center">
                                        ...
                                        <a href="<?php echo UField('list', $sort, 'type_title', $filter);?>" class="<?php echo CField($sort, 'type_title');?>">类型</a>
                                    </td>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                            <input type="checkbox" name="selected[]" value="<?php echo ($row['type_id']); ?>" />
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo U('edit', ['type_id'=>$row['type_id']]);?>" data-toggle="tooltip" title="编辑" class="btn btn-primary">
