                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a href="javascript:;" class="">头像</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">邮箱</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">电话</a>
                                    </td>                                    <td class="text-left">
                                        <a href="javascript:;" class="">密码</a>
                                    </td>                                    <td class="text-left">
                                        <a href="<?php echo UField('list', $sort, 'time', $filter);?>" class="<?php echo CField($sort, 'time');?>">添加时间</a>
                                    </td>
