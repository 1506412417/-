                    ...
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-pic">头像</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="pic" value="<?php echo ($data['pic']); ?>" placeholder="头像" id="input-pic" class="form-control">
                                        <?php if(isset($message['errorInfo']['pic'])): ?><label for="input-pic" class="text-danger"><?php echo ($message['errorInfo']['pic']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-email">邮箱</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="email" value="<?php echo ($data['email']); ?>" placeholder="邮箱" id="input-email" class="form-control">
                                        <?php if(isset($message['errorInfo']['email'])): ?><label for="input-email" class="text-danger"><?php echo ($message['errorInfo']['email']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-phone">电话</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="phone" value="<?php echo ($data['phone']); ?>" placeholder="电话" id="input-phone" class="form-control">
                                        <?php if(isset($message['errorInfo']['phone'])): ?><label for="input-phone" class="text-danger"><?php echo ($message['errorInfo']['phone']); ?></label><?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-time">添加时间</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="time" value="<?php echo ($data['time']); ?>" placeholder="添加时间" id="input-time" class="form-control">
                                        <?php if(isset($message['errorInfo']['time'])): ?><label for="input-time" class="text-danger"><?php echo ($message['errorInfo']['time']); ?></label><?php endif; ?>
                                    </div>
                                </div>
