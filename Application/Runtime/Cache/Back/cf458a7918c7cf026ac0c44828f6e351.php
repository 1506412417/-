        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo U('list');?>">商品类型(type)</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- /php4/buyplus/index.php/Back/Type/add -->
                    <form action="<?php echo U('');?>" method="post" enctype="multipart/form-data" id="form-set" class="form-horizontal">
                        <?php if(ACTION_NAME == 'edit'): ?><input type="hidden" name="type_id" id="input-type_id" value="<?php echo ($data['type_id']); ?>"><?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                    ...
                                    <label class="col-sm-2 control-label" for="input-type_title">类型</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="type_title" value="<?php echo ($data['type_title']); ?>" placeholder="类型" id="input-type_title" class="form-control">
                                        <?php if(isset($message['errorInfo']['type_title'])): ?><label for="input-type_title" class="text-danger"><?php echo ($message['errorInfo']['type_title']); ?></label><?php endif; ?>
                                    </div>
                                </div>
